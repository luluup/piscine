...
if(isset($_GET['id'])) 
{
   ...
   $dataclientrecup = $bdd->prepare('SELECT * FROM administrateur WHERE id = ?');
...
?>
   <html>
      ...
      ?>
               ...
               <span id="ajoutvendeur"><a href="ajoutvendeur.html"><img src="boutons/ajout-vendeur.png"></a></span>
               <span id="supprimervendeur"><a href="supprimer-vendeur.html"><img src="boutons/sup-vendeur.png"></a></span> 
